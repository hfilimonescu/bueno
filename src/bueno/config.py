...
class Config:
    ...
    MAIL_DEFAULT_SENDER = os.environ.get(
        "MAIL_DEFAULT_SENDER", "donotreply@example.com"
    )
    ...
    USE_CORS = os.environ.get("USE_CORS", True)
    ...
    OAUTH2_REDIRECT_URI = (
        os.environ.get("OAUTH2_REDIRECT_URI")
        or "http://localhost:3000/oauth2/{provider}/callback"
    )
